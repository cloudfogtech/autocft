...
func cloudflareGetConfigToConfig(cfConfig *zero_trust.TunnelCloudflaredConfigurationGetResponseConfigIngress) *model.IngressConfig {
	...
	return &model.IngressConfig{
		...
		Origin: &model.IngressOriginConfig{
			...
			MatchSNItoHost:         cfConfig.OriginRequest.MatchSnItoHost,
...
func configToCloudflareUpdateConfig(defaultIngressConfig *model.IngressConfig, updateIngressConfig *model.IngressConfig) *zero_trust.TunnelCloudflaredConfigurationUpdateParamsConfigIngress {
	...
	cfConfig := &zero_trust.TunnelCloudflaredConfigurationUpdateParamsConfigIngress{
		...
		OriginRequest: cloudflare.F(zero_trust.TunnelCloudflaredConfigurationUpdateParamsConfigIngressOriginRequest{
			...
			MatchSnItoHost:         cloudflare.F(ingressConfig.Origin.MatchSNItoHost),
...
func mergeOriginConfigs(primary, fallback *model.IngressOriginConfig) *model.IngressOriginConfig {
	...
	return &model.IngressOriginConfig{
		...
		MatchSNItoHost:         utils.MergeBoolField(primary.MatchSNItoHost, fallback.MatchSNItoHost),
